...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-env-vars "GOOGLE_CLOUD_PROJECT=${PROJECT_ID},GOOGLE_CLOUD_LOCATION=global,GOOGLE_GENAI_USE_VERTEXAI=true,MODEL=${MODEL},BRIDGE_BIGQUERY_TABLE=${BRIDGE_BIGQUERY_TABLE},BIGQUERY_JOB_PROJECT=${PROJECT_ID},BIGQUERY_LOCATION=${BIGQUERY_LOCATION}" \
  --quiet
